...
class MealRecipesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $mealRecipe1->image = 'https://i.dietdoctor.com/wp-content/uploads/2016/05/DD-81.jpg?auto=compress%2Cformat&w=1600&h=1067&fit=crop 1600w';
        $mealRecipe1->meal_boxes_fk = '1';
        $mealRecipe1->time = '40 min';
        $mealRecipe1->servings = '1';
        $mealRecipe1->save();
        ...
        $mealRecipe2->image = 'https://i.dietdoctor.com/wp-content/uploads/2019/07/keto_seared_salmon_creamy_lemon_sauce_h.jpg?auto=compress%2Cformat&w=1600&h=1067&fit=crop 1600w';
        $mealRecipe2->meal_boxes_fk = '1';
        $mealRecipe2->time = '30 min';
        $mealRecipe2->servings = '1';
        $mealRecipe2->save();
        ...
        $mealRecipe3->image = 'https://i.dietdoctor.com/wp-content/uploads/2019/04/Grilled-salmon-avocado-topping-2.jpg?auto=compress%2Cformat&w=1200&h=740&fit=crop 1200w';
        $mealRecipe3->meal_boxes_fk = '1';
        $mealRecipe3->time = '30 min';
        $mealRecipe3->servings = '1';
        $mealRecipe3->save();
        ...
        $mealRecipe4->image = 'https://skinnyfitalicious.com/wp-content/uploads/2016/01/turkey-sweet-potato-casserole-img8-1.jpg';
        $mealRecipe4->meal_boxes_fk = '2';
        $mealRecipe4->time = '75 min';
        $mealRecipe4->servings = '1';
        $mealRecipe4->save();
        ...
        $mealRecipe5->image = 'https://d2gtpjxvvd720b.cloudfront.net/system/recipe/image/1816/retina_hungry-girl-healthy-spaghetti-squash-shrimp-scampi.jpg';
        $mealRecipe5->meal_boxes_fk = '2';
        $mealRecipe5->time = '60 min';
        $mealRecipe5->servings = '1';
        $mealRecipe5->save();
        ...
        $mealRecipe6->image = 'https://reluctantentertainer.com/wp-content/uploads/2019/04/Skillet-Lemon-Chicken-1.jpg';
        $mealRecipe6->meal_boxes_fk = '2';
        $mealRecipe6->time = '40 min';
        $mealRecipe6->servings = '1';
        $mealRecipe6->save();
        ...
        $mealRecipe7->image = 'https://cookieandkate.com/images/2014/02/creamy-vegan-butternut-squash-linguine-recipe.jpg';
        $mealRecipe7->meal_boxes_fk = '3';
        $mealRecipe7->time = '55 min';
        $mealRecipe7->servings = '1';
        $mealRecipe7->save();
        ...
        $mealRecipe8->image = 'https://cookieandkate.com/images/2015/01/sweet-potato-green-rice-burrito-bowls-recipe-1.jpg';
        $mealRecipe8->meal_boxes_fk = '3';
        $mealRecipe8->time = '65 min';
        $mealRecipe8->servings = '1';
        $mealRecipe8->save();
        ...
        $mealRecipe9->image = 'https://cookieandkate.com/images/2014/01/peanut-soba-noodles-slaw.jpg';
