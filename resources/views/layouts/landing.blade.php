...
<div class="landing">
    ...
    <section id="how-it-works" class="module-padding">
        <div class="row">
            <div class="col-md-12">
                <h2>How It Works</h2>
            </div>
    ...
    <section id="find-recipes" class="module-padding">
        <div class="row">
            <div class="col-md-12">
                <h2>Find Recipes</h2>
            </div>
        ...
        <div class="row cards">
            <?php foreach ($mealRecipes as $recipe) :?>
    ...
    <section id="ingredients" class="module-padding">
        <div class="row">
            <div class="col-md-12">
                <h1>Discover</h1>
            </div>
    ...
    <section id="get-to-cooking" class="module-padding">
        <div class="row">
    ...
    <div class="container">
     ...
     <section class="module-padding" id="our-story">
        <div class="row">
            <div class="col-md-12">
                <h2>Our Story</h2>
            </div>
    ...
    <section class="module-padding" id="instagram">
        <div class="row">
            <div class="col-md-12">
