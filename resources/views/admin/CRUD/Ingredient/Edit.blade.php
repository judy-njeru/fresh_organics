...
<div id="contents">
  @include('admin.components.top')
    ...
    <div class="col-sm-6 text-right">
        <a href="{{ route('meal-boxes.index') }}" class="btn btn-danger mb-2">Go Back</a> 
    </div>    
    </div>
    <hr />
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <a href="{{ route('meal-recipes.index') }}/<?= $mealRecipe['meal_boxes_fk'] ?>" class="btn btn-danger">Cancel</a> 
        </div>
    </div>
