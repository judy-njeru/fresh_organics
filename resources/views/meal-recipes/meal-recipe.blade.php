...
<div id="meal-recipe" class="module-padding">
    <div class="container">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 mb-4 ">
                ...
                <div class="ingredients">
                    ...
                    <div class="ingredient">
                        <img src="{{url('/uploads/ingredients')}}/{{$ingredient->image}}">
                        <p>{{$ingredient->name}}</p>
                    </div>
                    @endforeach
                </div>
        ...
        <div class="nutrition-overlay">
            ...
            <div class="content">
                @foreach($nutrition->nutrition as $nutrient)
                <div class="info">
                    <div>{{$nutrient->name}}</div>
                    <div>{{$nutrient->getOriginal('pivot_amount')}}</div>
                </div>
                @endforeach
            </div>
        </div>
